...
<div class='container-fluid p-0 mt-5'>
    <div class='mt-5 pt-3'>
    <h4 class='fw-light pt-5 mt-5'>A propos de <span class='fw-bold'>Nous</span></h4>
    </div>
    <div class="row">
        <div class="col-md-6">
        ...
        <div class="col-md-6 d-flex justify-content-center align-items-center">
            <div class='p-5'>
                ...
                <a href="#" class ='text-decoration-none text-danger'>En savoir plus <i class="fa-solid fa-arrow-right  "></i></a>
            </div>
        </div>
    </div>
    <div class="row">
        ...
        <div class="col-md-6">
            <img src="/medias/max (2).png" class="w-100" alt="...">
        </div>
    </div>
    <div class="row">
        <div class="col-md-6">
