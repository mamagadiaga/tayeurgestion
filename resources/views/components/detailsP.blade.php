...
<div class="progress w-25  m-4" style="height: 2px;">
  <div class="progress-bar bg-danger" role="progressbar" aria-label="Example 1px high" style="width: 100%;" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
</div>
</div>
<div class="card shadow border-0">
<div class="card-body">
<p class='fw-bold'>INFORMATION CONTACT</p>
<div class="progress mb-3" style="height: 2px;">
  <div class="progress-bar bg-danger" role="progressbar" aria-label="Example 1px high" style="width: 10%;" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
</div>
<h6 class='mb-4'>
...
<div class="row">
    <a class="btn btn-danger rounded-pill w-auto m-2" href="#" role="button">Taille basse</a>
    <a class="btn btn-danger rounded-pill w-auto m-2" href="#" role="button">Robe</a>
    <a class="btn btn-danger rounded-pill w-auto m-2" href="#" role="button">Grand boubou femme</a>
    <a class="btn btn-danger rounded-pill w-auto m-2" href="#" role="button">Costume</a>
    <a class="btn btn-danger rounded-pill w-auto m-2" href="#" role="button">Costume africain</a>
    <a class="btn btn-transparent border-secondary text-danger rounded-pill w-auto m-2" href="#" role="button">Fil a fil</a>
    <a class="btn btn-danger rounded-pill w-auto m-2" href="#" role="button">Baye lathe</a>
    <a class="btn btn-danger rounded-pill w-auto m-2" href="#" role="button">Taille mame</a>
    <a class="btn btn-danger rounded-pill w-auto m-2" href="#" role="button">Taille haute</a>
</div>
</div>
</div>
...
<div class="card-body">
<p class='fw-bold'>EMPLOI DU TEMPS</p>
<div class="progress mb-3" style="height: 2px;">
  <div class="progress-bar bg-danger" role="progressbar" aria-label="Example 1px high" style="width: 10%;" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
</div>
...
<div class="progress mb-3" style="height: 2px;">
  <div class="progress-bar" role="progressbar" aria-label="Example 1px high" style="width: 10%;" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
</div>
<p>
    Lorem ipsum dolor sit amet consectetur adipisicing elit. Accusantium ab ducimus nihil incidunt adipisci, nesciunt voluptas dolores placeat. Quas libero praesentium, perferendis ab laudantium mollitia aliquam iusto velit illum saepe.
    Lorem ipsum dolor sit amet consectetur adipisicing elit. Accusantium ab ducimus nihil incidunt adipisci, nesciunt voluptas dolores placeat. Quas libero praesentium, perferendis ab laudantium mollitia aliquam iusto velit illum saepe.
    Lorem ipsum dolor sit amet consectetur adipisicing elit. Accusantium ab ducimus nihil incidunt adipisci, nesciunt voluptas dolores placeat. Quas libero praesentium, perferendis ab laudantium mollitia aliquam iusto velit illum saepe.
</p>
</div>
...
<div class="card shadow mt-4 border-0">
<div class="card-body">
<p class='fw-bold'>COMMENTAIRES(3)</p>
<div class="progress mb-3" style="height: 2px;">
  <div class="progress-bar bg-danger" role="progressbar" aria-label="Example 1px high" style="width: 10%;" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
</div>
...
<p class="text-secondary">Tres bonne qualite franchement</p>
</div>
</div>
<div class="card bg-light shadow-sm m-4 border-0">
<div class="card-body">
...
<p class="text-secondary">1 Like</p>
</div>
</div>
</div>
<div class="card bg-light shadow-sm m-4 border-0">
...
<div class="form-floating ">
  ...
  <label class="text-secondary">Ecrivez un commentaire</label>
</div>
</div>
</div>
    </div>
...
<div class="card shadow border-0">
<div class="card-body">
<p class='fw-bold'>NOTEZ LA BOUTIQUE</p>
<div class="progress mb-3" style="height: 2px;">
  <div class="progress-bar bg-danger" role="progressbar" aria-label="Example 1px high" style="width: 10%;" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
</div>
<div class="text-center p-5">
    <h5 class="mb-3">Notez la boutique</h5>
    <span class="fw-light align-items-center">
    <i class="fa-solid fa-star text-secondary fs-1 text-opacity-50"></i>
    <i class="fa-solid fa-star text-secondary fs-1 text-opacity-50"></i>
    <i class="fa-solid fa-star text-secondary fs-1 text-opacity-50"></i>
    <i class="fa-solid fa-star text-secondary fs-1 text-opacity-50"></i>
    <i class="fa-solid fa-star text-secondary fs-1 text-opacity-50"></i>
...
<div class="row mt-4">
  <div class="col">
    <input type="text" class="form-control bg-light border-0 shadow-sm" placeholder="Nom" aria-label="First name">
  </div>
  <div class="col">
    <input type="email" class="form-control bg-light border-0 shadow-sm" placeholder="Email" aria-label="Email">
  </div>
</div>
<div class="row mt-4">
<div class="form-floating">
  <textarea class="form-control bg-light border-0 shadow-sm" placeholder="Leave a comment here" id="floatingTextarea2" style="height: 150px"></textarea>
</div>
</div>
<div class="row p-3 mt-4">
<a class="btn btn-danger rounded-pill w-100 " href="#" role="button">ENVOYER</a>
</div>
</form>
</div>
</div>
...
<span class="text-danger me-2 fs-1"><i class="fa-solid fa-quote-left"></i></span>
    ...
    <h6>JOHN SMITH</h6>
    <h6 class="text-secondary">Founde of Awesomeeux Technology</h6>
</div>
</div>
    </div>
    <div class="col-md-4 mb-4 mt-4 text-white">
